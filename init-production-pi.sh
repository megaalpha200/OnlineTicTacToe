...
#3. Copy the ".env" file into the root of the production/backend folder.
echo "### Copying .env File to Production Backend..."
cp ./.env ./production/backend/.env
echo

#4. Copy the "build" folder into the root of the production/frontend folder.
#echo "### Copying build folder to Production Frontend..."
#cp -r ./build ./production/frontend/build
#echo

#5. Setup Appropriate Dockerfiles
#echo "### Setting up Frontend Dockerfile..."
#mv ./production/frontend/DockerfilePi ./production/frontend/Dockerfile
echo "### Setting up Backend Dockerfile..."
mv ./production/backend/DockerfilePi ./production/backend/Dockerfile
echo "### Setting up Docker Compose File..."
mv ./production/docker-compose-pi.yml ./production/docker-compose.yml
